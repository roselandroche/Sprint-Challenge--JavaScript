...
*/
// const animalNames = zooAnimals.forEach((zooAnimal) => {
//   return ['animal_name': zooAnimal.animal_name, 'scientific_name': zooAnimal.scientific_name];
// }

const animalNames = [zooAnimals.forEach((zooAnimal) => {
  return `Name: ${zooAnimal.animal_name}, Scientific: ${zooAnimal.scientific_name}.`;
})];
